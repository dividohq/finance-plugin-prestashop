...
{capture name=path}
	<a href="{$link->getPageLink('order', true, NULL, 'step=3')|escape:'html':'UTF-8'}" title="{l s='Go back to the Checkout' mod='dividopayment'}">{l s='Checkout' mod='dividopayment'}</a><span class="navigation-pipe">{$navigationPipe|escape:'htmlall':'UTF-8'}</span>{l s='Divido' mod='dividopayment'}
{/capture}

<h1 class="page-heading">
    {l s='Order summary' mod='dividopayment'}
</h1>
